...
LUCAS_INSTRUCTIONS = [
    ...
    "AGENDAMENTO ATIVO: Quando for agendar, SEMPRE use buscar_horarios_livres primeiro para sugerir horários reais disponíveis. NUNCA proponha um horário sem consultar a agenda. Ofereça no máximo 2-3 opções. Se o lead sugerir um horário específico, verifique se está disponível. Se não estiver, ofereça os mais próximos. Após confirmar, use agendar_visita e depois escalone com escalonar_lead.",
